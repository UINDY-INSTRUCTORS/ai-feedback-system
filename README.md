...
**Option A: Write Rubric in Markdown (Recommended - Default!)**
...
# Note: rubric.yml is already in .gitignore (auto-generated by GitHub Actions)
# The workflow automatically converts RUBRIC.md → rubric.yml when students request feedback
```
